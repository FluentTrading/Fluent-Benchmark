package com.fluent.benchmark.queue.normal;
...
public class QueuePerformanceComparison{
    ...
    public static void main( final String[ ] args ) throws Exception {
        ...
        String queueName    = (queueType == 0) ? "ArrayBlockingQueue" : (queueType == 1 ? "SPSCQueue" : "MPSCQueue");

        Queue<Integer> queue = createQueue( queueType );
        System.out.println( "QueueName: " + queueName + ", Capacity: " + QUEUE_CAPACITY + ", Repetitions: " + REPETITIONS );
